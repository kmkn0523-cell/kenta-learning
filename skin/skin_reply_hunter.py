...
KEYWORD_MAP = {
    "1": ["腸", "便秘", "発酵", "食物繊維", "腸活"],          # 腸活・食事系
    "2": ["寝", "睡眠", "夜更かし", "寝不足"],                # 睡眠・生活習慣系
    "3": ["化粧水", "保湿", "乾燥", "スキンケア"],            # スキンケア・化粧品系
    "4": ["ニキビ", "肌荒れ", "吹き出物", "赤み"],            # ニキビ悩み・共感系
    "5": ["サプリ", "ビタミン", "亜鉛", "鉄", "栄養"],        # サプリ・栄養系
    "6": ["ファスティング", "断食", "16時間"],               # ファスティング・断食系
}
