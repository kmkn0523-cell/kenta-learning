...
def create_premium_image():
    ...
    # ===== サブタイトル =====
    font_sub = ImageFont.truetype(FONT_NORMAL, 28)
    sub_text = '皮脂・ニキビ・慢性肌荒れの"本当の原因"と、30日で体感が変わる再現プログラム'
    ...
    # ===== 保存 =====
    save_path = "/home/kenta_kamijyo/skin/lp_premium.png"
    img.save(save_path)
...
if __name__ == "__main__":
    ...
    print("\n🎉 完成しました！")
    print("保存先: /home/kenta_kamijyo/skin/lp_premium.png")
