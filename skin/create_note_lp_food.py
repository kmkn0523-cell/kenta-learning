"""
有料Note用LP画像を生成するスクリプト（食事・インナーケア編）
サイズ: 1280×670px
スタイル: 黒×ゴールドの高級感デザイン
出力: lp_food_premium.png
"""
...
def create_premium_image():
    ...
    sub_text = "インナーケア神食材10選・1週間献立・5分メニュー・コンビニ攻略まで完全網羅"
    ...
    # ===== 保存 =====
    save_path = "/home/kenta_kamijyo/skin/lp_food_premium.png"
    img.save(save_path)
...
if __name__ == "__main__":
    print("食事編プレミアムLP画像を生成中...\n")
    create_premium_image()
    print("\n🎉 完成しました！")
    print("保存先: /home/kenta_kamijyo/skin/lp_food_premium.png")
