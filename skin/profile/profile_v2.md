...
- [x] 上記の表示名・自己紹介・固定ポストを自分の言葉で見直した
- [x] Threads アプリで表示名・自己紹介を反映
- [x] Threads アプリで固定ポストを投稿 → ピン留め
- [x] Instagram アプリで名前・自己紹介を反映
- [x] Instagram アプリで固定ポスト相当のキャプション投稿（or プロフィール直下に固定）
