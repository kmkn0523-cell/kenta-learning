...
# 投稿文に含まれる英語キーワード → どのカテゴリーのテンプレを出すか の対応表
# （ronin_comment_templates.py の6カテゴリ "1"〜"6" に合わせる。相手の投稿は英語なので英語で判定）
KEYWORD_MAP = {
    "1": ["discipline", "habit", "routine", "consistency", "willpower", "consistent"],   # 規律・習慣
    "2": ["fail", "failure", "struggle", "adversity", "setback", "quit", "hard time"],   # 逆境・打たれ強さ
    "3": ["focus", "distraction", "distracted", "procrastinate", "attention", "deep work"],  # 集中・誘惑
    "4": ["stoic", "stoicism", "mindset", "calm", "anxiety", "fear", "control"],          # ストイック・心の在り方
    "5": ["master", "mastery", "skill", "craft", "practice", "improve", "discipline of"], # 熟達・鍛錬
    "6": ["purpose", "meaning", "goal", "vision", "direction", "why", "ikigai"],          # 目的・意味
}
