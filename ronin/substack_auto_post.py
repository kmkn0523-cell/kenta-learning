...
from playwright_stealth import stealth_sync      # headlessブラウザ検知を回避するフィンガープリント偽装
...
def create_and_publish_post(proverb, image_url):
    ...
    with sync_playwright() as p:
        ...
        # playwright-stealth でheadlessブラウザの多数のフィンガープリントを一括偽装する
        # navigator.webdriver, plugins, languages, WebGL, canvas など全て対応
        stealth_sync(page)
