...
def test_CTAサイクル_同テーマ複数ある場合は新しい記事を優先する():
    # articlesは履歴の古い順→新しい記事(discipline-2)が優先されるべき
    articles = [
        {"title": "Discipline and Consistency Build Habits",
         "url": "https://roninwords.substack.com/p/discipline-1"},
        {"title": "Real Self-Control Through Daily Discipline",
         "url": "https://roninwords.substack.com/p/discipline-2"},
    ]
    line = action.cta_line_for_cycle(7, theme_key="1", substack_articles=articles)
    assert "https://roninwords.substack.com/p/discipline-2" in line
